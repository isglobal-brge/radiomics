...
```{r}
final_results2 <- data.frame("ACCURACY" = c("No balancing", "SMOTE", "Down Sample"),
                            "Boosting" = c(boosting_not_balanced2, boosting_smote2, "-"),
                            "Random Forest" = c(rf_not_balanced2, rf_smote2, "-"),
                            "XGBoost" = c(xgboost_not_balanced2, xgboost_smote2, xgboost_down2))
final_results2
```
...
```{r}
print(list("Predict COPD vs Non COPD" = final_results, "Predict types of COPD" = final_results2))
```
