...
Load radiomic features and clinic data. Since they differ int the number of id, we will only keep common ids.
```{r}
## Radar object
...
Load clinic data and radiomic features. Since they differ int the number of id, we will only keep common ids.
```{r}
## Radar object
file <- listRDA("rdr_L1_Andrea.rda")
rdr_L1 <- file$rdr_L1
