...
Summary:
```{r}
final_results <- data.frame("ACCURACY" = c("No balancing", "SMOTE", "Down Sample", "Up Sample"),
                            "Boosting" = c(boosting_not_balanced, boosting_smote, boosting_down, boosting_up),
...
down_data <- cbind(data.frame(down_data$x), data.frame(down_data$y))
names(down_data)[names(down_data) == 'down_data.y'] <- 'COPD_values'
...
```{r}
final_results2 <- data.frame("ACCURACY" = c("No balancing", "SMOTE", "Down Sample", "Up Sample"),
                            "Boosting" = c(boosting_not_balanced2, boosting_smote2, boosting_down2, boosting_up2),
