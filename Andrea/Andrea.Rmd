...
```{r, echo=FALSE, warning=FALSE, message=FALSE, out.width = "100px", out.height = "200px"}
library(oro.dicom)
library(RIA)
...
```{r, out.width = "100px", out.height = "200px"}
...
```{r, message=FALSE, out.width = "500px", out.height = "200px"}
...
```{python, out.width = "250", results = FALSE}
