...
knitr::include_graphics("./img/lungct1.png")
```
...
```
```{r, echo=FALSE, fig.align="center"}
knitr::include_graphics("./img/lungct2.png")
```
...
```
```{r, echo=FALSE, fig.align="center"}
knitr::include_graphics("./img/lungct3.png")
```
```{r eval = FALSE, results = FALSE, message=FALSE}
...
```
```{r, echo=FALSE, fig.align="center"}
knitr::include_graphics("./img/lungct4.png")
```
